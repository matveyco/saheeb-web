...
export function DriveTrustSection({
  ...
  return (
    <section className="border-b border-[#2A2633] bg-[#0A0A0D] py-12 lg:py-16">
      <Container>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {content.trustCards.map((card) => (
            <button
              ...
              className="group rounded-[1.75rem] border border-[#2A2633] bg-[#0F1013] p-6 text-start transition-colors hover:border-[#316BE9]/40 hover:bg-[#141418]"
