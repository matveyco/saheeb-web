  ...
  return (
    <>
      ...
      <main className="pt-20 lg:pt-24">
        ...
        {/* Important Notice */}
        <section className="py-6 bg-[#316BE9]/10 border-y border-[#316BE9]/20">
          <Container size="md">
            <p className="text-[#316BE9] font-medium text-center">
              {t('importantNotice')}
            </p>
          </Container>
        </section>
        ...
        <section className="py-12 lg:py-16 bg-[#0F1013]">
          <Container size="md">
            ...
            <div className="mt-16 pt-8 border-t border-[#2A2633]">
              <h2 className="text-3xl font-bold text-[#316BE9] mb-8">
                {t('saheebDrive.title')}
              </h2>
              <p className="text-[#8F859C] mb-8">{t('saheebDrive.intro')}</p>
              ...
              {[
                ...
                <div key={driveSection} className="mb-10">
                  <div className="flex items-start gap-4 mb-4">
                    <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#316BE9]/20 flex items-center justify-center text-[#316BE9] text-sm font-semibold">
